-- Migration: Add CIN verification columns and ROC companies table
-- Purpose: Enable instant MCA/ROC CIN verification for startups and investors

-- ============================================================================
-- Add CIN columns to existing tables
-- ============================================================================

-- Add CIN column to profiles (for corporate investor profiles)
...
('U51234MH2021PTC342876', 'SynthWave Technologies Limited', '2021-07-08', 'Private', 'Private Company', 'Unlisted', 1000000.00, 500000.00, 'ROC-MUMBAI', '12 Maker Chambers, Fort, Mumbai 400001', 'Maharashtra', 'Under Liquidation', 'Software Development'),
-- Additional Active Companies
('U67110TG2023PTC099876', 'GreenEnergy Innovations Telangana Pvt Ltd', '2023-06-12', 'Private', 'Private Company', 'Unlisted', 6000000.00, 3000000.00, 'ROC-HYDERABAD', '7-1-584, Begumpet, Hyderabad 500016', 'Telangana', 'Active', 'Renewable Energy / Solar Solutions'),
('U75110DL2022PTC389201', 'Delhi Digital Ventures Limited', '2022-09-18', 'Private', 'Private Company', 'Unlisted', 2500000.00, 1250000.00, 'ROC-DELHI', '15/48 Bahadur Shah Zafar Marg, New Delhi 110002', 'Delhi', 'Active', 'Information Technology / E-Commerce'),
('U52110TN2023PTC098765', 'Chennai Ventures Biotech Private Limited', '2023-04-05', 'Private', 'Private Company', 'Unlisted', 3500000.00, 1750000.00, 'ROC-CHENNAI', '456 Mount Road, Teynampet, Chennai 600018', 'Tamil Nadu', 'Active', 'Biotechnology / Medical Devices'),
('U35304WB2020PTC259876', 'Merged Holdings Limited', '2020-01-30', 'Private', 'Private Company', 'Unlisted', 800000.00, 400000.00, 'ROC-KOLKATA', '234 Park Street, Kolkata 700016', 'West Bengal', 'Amalgamated', 'Financial Holdings'),
('U45100GJ2021PTC056789', 'Gujarat Manufacturing Works Limited', '2021-03-22', 'Private', 'Private Company', 'Unlisted', 2000000.00, 1000000.00, 'ROC-AHMEDABAD', '123 Industrial Area, Odhav, Ahmedabad 382415', 'Gujarat', 'Under CIRP', 'Manufacturing')
